...
#table(
  ...
  ..("", "", "Umsatz CHF", "Umsatz CHF").map(h => text(
    h,
    weight: "bold",
  )),
  "200",
...
#table(
  ...
  "220", "Leistungen ins Ausland", input.total_exports_revenue, "",
  "221",
  ...
  // TODO
  "", "", "", "",
  "", "289", "Total Abzüge Ziffer 220 bis 280", "",
...
#table(
  ...
  "",
  // TODO
  "343", "Leistungen zum Beherbergungssatz Satz 3.8%", "",
  // TODO
  "",
  // TODO
  "",
  ...
  "",
  "379",
  "Steuerbarer Gesamtumsatz (wie Ziff. 299)",
  input.total_domestic_revenue,
  "",
  "",
  "",
...
#table(
  ...
  "",
  "410",
  "Einlageentsteuerung (Art. 32, bitte detaillierte Aufstellung einreichen)",
  "",
  // TODO
  "",
  // TODO
  ...
  // TODO
  "420",
  "Vorsteuerkürzungen: Nicht-Entgelte wie Subventionen, Tourismusabgaben usw. (Art. 33 Abs. 2)",
  "",
  // TODO
  "",
  // TODO
...
#table(
  columns: (auto, 3fr, 1fr, 1fr),
  align: (x, y) => (left, left, right, right).at(x),
  ..("", "", "Betrag CHF", "").map(h => text(h, weight: "bold")),
  "900",
  ...
  "",
  // TODO
  "910", "Spenden, Dividenden, Schadenersatz usw. (Bst. d-l)", "",
  // TODO
  "",
  // TODO
)
...
#table(
  ...
  table.header("Date", "Amount", "Amount CHF", "VAT", "VAT CHF"),
  ..input
    .revenues
    .map(revenue => (
      revenue.day,
