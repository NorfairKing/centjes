...
spec = do
  ...
  describe "renderDecimalLiteral" $ do
    ...
    it "can render 57646075230342348.8 correctly" $
      renderDecimalLiteral (DecimalLiteral False 1 (scientific 576460752303423488 (-1)))
  ...
  describe "parseDecimalLiteral" $ do
    ...
    it "can parse 12.00045" $
      parseDecimalLiteral "12.00045" `shouldBe` Just (DecimalLiteral False 5 (scientific 1200045 (-5)))
