...
, QuickCheck, really-safe-money, really-safe-money-gen
, safe-coloured-text, sydtest, sydtest-discover, text, vector
}:
mkDerivation {
  pname = "centjes-gen";
  version = "0.0.0.0";
  ...
  testHaskellDepends = [
    ...
    really-safe-money safe-coloured-text sydtest text vector
  ];
