...
, genvalidity-vector, lib, monad-logger, mtl, opt-env-conf, path
, path-io, QuickCheck, really-safe-money, really-safe-money-gen
, safe-coloured-text, sydtest, sydtest-discover, text, time, vector
, yaml
}:
mkDerivation {
  pname = "centjes-gen";
