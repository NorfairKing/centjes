...
, path-io, prettyprinter, prometheus, prometheus-ghc-stats
, prometheus-wai, safe-coloured-text, shakespeare, skylighting
, sydtest, sydtest-discover, template-haskell
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    centjes-import-revolut centjes-stocks centjes-switzerland cmark
    containers data-default file-embed filepath fsnotify opt-env-conf
    path path-io prettyprinter prometheus prometheus-ghc-stats
    prometheus-wai safe-coloured-text shakespeare skylighting
